...
class CampingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camping" do
    assert_difference("Camping.count") do
      post campings_url, params: { camping: { city: @camping.city, definition: @camping.definition, name: @camping.name, region: @camping.region } }
    end
  ...
  test "should update camping" do
    patch camping_url(@camping), params: { camping: { city: @camping.city, definition: @camping.definition, name: @camping.name, region: @camping.region } }
